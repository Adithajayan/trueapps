...
SECRET_KEY = 'django-insecure-mqq8i_@8@d_=nwp569c-woca91g=6xqq=sp%zf%3j(epig0$ir'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'config.context_processors.job_notifications',
...
# Pazhaya DATABASES maatti ithu kodukkuka
DATABASES = {
